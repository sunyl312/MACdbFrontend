<template>
  <v-app style="margin-top: 0px ;background-color: #ecf0f5;" >
    ...
    >
      ...
      >
        <v-sheet :color="barcolor"  class="float-end text-right  pr-6 ">
          ...
          <span class="white--text text-body-2 ">V1.1</span>
        </v-sheet>
      </v-col>
      </v-row>
    ...
    <v-btn :color="$store.state.mainColor" dark elevation="1" x-small fab style="position: fixed;bottom: 60px;right: 50px;z-index: 99999999"
...
// import CitationDownload from "./components/sub/citationDownload";
import CitationDownloadSideBar from "./components/sub/citationDownloadSideBar";

export default {
  name: 'App',
  components: {CitationDownloadSideBar, FooterBar, HeaderBar},
  data() {
    return {
