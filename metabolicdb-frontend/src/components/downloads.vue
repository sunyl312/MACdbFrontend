                  ...
                  <v-sheet class="mt-6">
                    ...
                    <v-sheet class="text-left mb-2 mt-4">
                      ...
                      <br> Database Resources of the National Genomics Data Center, China National Center for Bioinformation in 2022. Nucleic Acids Res 2022, 50(D1):D27-D38. [PMID=<a
                        ...
                        :style="{color:hilightColor,textDecoration:'none'}" target="_blank">10.1093/nar/gkab951</a>] <citation-download offset="y" :icon-color="$store.state.mainColor" endnote="static/citation/ngdc_paper_endnote.RIS"  bib="static/citation/ngdc_paper_bibtex.bib"></citation-download>
                    </v-sheet>
                  </v-sheet>
                </v-sheet>
              </v-col>
...
export default {
  name: "downloads",
  components: {CitationDownload, BreadCrumb},
  data() {
    return {
      hilightColor: '#0d8dd2',
      breadcrumbData: [
