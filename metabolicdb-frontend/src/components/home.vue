            ...
            <v-col class="mt-2" lg="12" md="12" sm="12">
              ...
              <v-sheet class="z-transparent pt-8 pb-3">
                <v-row align="center">
                  ...
                  <!--                  </v-col>-->
                  <v-col cols="12">
                    <v-sheet class="py-4 white--text z-transparent mx-16" rounded style="font-size: 0">

                      <span class="red--text text-h3 ">M</span>
                      <span class="orange--text darken-4 text-h3 ">A</span>
                      <span class="indigo--text text-h3 ">C</span>
                      <span class="white--text text-h3 ">
                      db:
                    </span>


                      <span class="text-h4"> A curated knowledgebase for <span class="red--text text-h4 ">M</span>etabolic  <span
                          class="orange--text darken-4 text-h4 ">A</span>ssociations across human <span
                          class="indigo--text lighten-3 text-h4 ">C</span>ancers</span>
                    </v-sheet>
          ...
          <v-row>
            <v-col cols="10" offset="1">
              ...
              <v-text-field
                  ...
                  hide-details
                  outlined
                  placeholder="Metabolite name, PubChem Cid, Cancer type, PubMed ID or Title, etc."
                  ...
                  <v-col class="text-left " cols="12">
                    <v-sheet class="pa-3" height="100%">
                      ...
                      <div>
                        ...
                        PubChem Cid mapping</a> and <a :style="{color:hilightColor,textDecoration:'none'}"
            ...
            <v-card :elevation="total_elevation" height="300">
              ...
              <v-sheet class="overflow-y-auto mx-2" height="220">
                <v-timeline align-top dense>
                  <v-timeline-item v-for="(item,idx) in news" :key="idx" fill-dot icon="mdi-star" small>
          ...
          <v-col cols="12" lg="3" md="6" sm="12" xl="3">
            <v-card :elevation="total_elevation" height="300">
              ...
              <v-card-text>
                ...
                <v-sheet height="220" style="overflow-y: visible !important;">
                  <v-row>
                    <v-col cols="12">
                      <v-sheet class=" mx-auto  ">
                        ...
                        <div class="text-left mb-2 mt-4">
                          ...
                          <span> <b>How to Cite:</b>
                                <v-sheet >
                                   <v-icon small>mdi-numeric-1-circle-outline</v-icon> MACdb: A curated knowledgebase for metabolic associations across human cancers. Molecular Cancer Res 2023, MCR-22-0909, [PMID=<a
                                    href="https://pubmed.ncbi.nlm.nih.gov/37027007/" style="text-decoration: none"
                                    target="_blank">37027007</a>] [DOI=<a
                                    href="https://doi.org/10.1158/1541-7786.MCR-22-0909" style="text-decoration: none"
                                    target="_blank">10.1158/1541-7786.MCR-22-0909</a>]
                                  <citation-download :icon-color="$store.state.mainColor" bib="static/citation/macdb.bib"
                                                     endnote="static/citation/macdb.RIS"
                                                     offset="y"></citation-download>

                                </v-sheet>
                                <v-sheet >
                                  <v-icon small>mdi-numeric-2-circle-outline</v-icon> Database Resources of the National Genomics Data Center, China National Center for Bioinformation in 2022. Nucleic Acids Res 2022, 50(D1):D27-D38. [PMID=<a
                                    :style="{color:hilightColor,textDecoration:'none'}"
                                    href="https://pubmed.ncbi.nlm.nih.gov/34718731/"
                                    target="_blank">34718731</a>][DOI=<a
                                    :style="{color:hilightColor,textDecoration:'none'}"
                                    href="https://doi.org/10.1093/nar/gkab951"
                                    target="_blank">10.1093/nar/gkab951</a>] <citation-download :icon-color="$store.state.mainColor"
                                                                                                bib="static/citation/ngdc_paper_bibtex.bib"
                                                                                                endnote="static/citation/ngdc_paper_endnote.RIS"
                                                                                                offset="y"></citation-download>
                                </v-sheet>
                               </span>
                        </div>
...
import CitationDownload from "./sub/citationDownload";

export default {
  name: "home",
  components: {CitationDownload},
  data() {
    return {
      bannerimg: require('../assets/img/macdb_background_1.png'),
      // bannerimg: require('../assets/img/midj-bg2-v.png'),
      searchTerm: "",
      ...
      news: [
        {
          date: "[2023/03/23]",
          text: "Add citation buttons"
        },
        {
          date: "[2023/02/22]",
          text: "Function improvements."
        },
        {
          date: "[2022/11/09]",
