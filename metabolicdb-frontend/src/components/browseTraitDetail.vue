      ...
      <v-col>
        <expand-panel title-name="Trait" >
          ...
          <v-row class="pb-8">
            ...
            <v-col class="text-left" cols="2">
              <span class="text-body-1 font-weight-bold " > #Publication:</span>
