<template>
  <div   :id="chartid" style="width: 99%;height: 90%;margin: 0 auto;"></div>
</template>
...
name: "topMetabolites",
  data() {
    return {
      myChart: null,
      dat: [],
      chartid:"thisChartTopMetabolites"
    }
    ...
    drawEcharts() {
        ...
        toolbox: {
          feature: {
            saveAsImage: {
              // type:"svg",
              title: "save",
              name:"MACdb_statistics_top_metabolites",
              pixelRatio: 4,
            }
          }
        },
        ...
        dataset: [
          {
            ...
            source: this.dat.topmetabolite_count,
            sourceHeader:true,
          },
        ],
        xAxis: {
      ...
      that.myChart.on('click', function(params) {
        ...
        //   else if(myattr.type == "cid"){
            ...
            that.$commonfunc.openAtNewPageMetaboliteDetail(params.data[1])
        //   }
        // }
