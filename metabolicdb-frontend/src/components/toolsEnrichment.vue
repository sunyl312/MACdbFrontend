                            ...
                            <v-row>
                              <v-col cols="12">
                               ...
                               <a class="my-auto" style="text-decoration: none ;" @click="demo('name')">#Example1 <help-msg>
                                 Metabolite names from Liu et.al. (PMID:<a href="https://pubmed.ncbi.nlm.nih.gov/31216740/" style="text-decoration: none" target="_blank">26549419</a>)
                               </help-msg></a> &nbsp; <a class="my-auto" style="text-decoration: none ;" @click="demo('cid')">#Example2
                                <help-msg>PubChem Cids from Liu et.al. (PMID:<a href="https://pubmed.ncbi.nlm.nih.gov/31216740/" style="text-decoration: none" target="_blank">26549419</a>), We use the "NameToCid" in MACdb to convert the metabolite names to PubchemCID</help-msg> </a>
