    ...
    <v-row>
      ...
      <v-col>
        ...
        <v-sheet class="text-justify my-6">
          ...
          NameToCid (map metabolite name to PubChem Cid), which plays an important role in standardizing
                  ...
                  <v-row align="center" >
                    ...
                    <v-col  cols="12" class="text-end">
                      ...
                      <v-btn :color="$store.state.mainColor"
                             ...
                             class="px-2 white--text " style="text-transform: none"
                             @click="checkTaskInterval">
                        <v-icon dark>mdi-lightbulb</v-icon>&nbsp Check
                      </v-btn>
                    </v-col>
                  </v-row>
