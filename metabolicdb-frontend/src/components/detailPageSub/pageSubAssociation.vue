        ...
        <v-col    :cols=" showFilters? 10 : 12">
          <v-sheet  outlined>
            ...
            >
              ...
              <vxe-column field="cid" title="PubChem Cid"  align="left"  sortable width="120">
                <template #default="{ row }">
                  <span> {{ row.cid }}</span>
...
import LegendHintHiddenTableColumns from "../tableLegends/LegendHintHiddenTableColumns";

export default {
name: "pageSubAssociation",
  components: {
    LegendHintHiddenTableColumns,
    OpenExternalLink, PvalSummary, DeltaTrendSummary, HelpMsg, PercentBarItemsPval, percentBarItems,LegendOpenExternalLink},
  props:["tid","idtype"],
  data() {
    return {
      allAlign: null,
